...
const projectTypes = [
  {
    ...
    name: 'Website',
    icon: Globe,
    description: 'Portfolio, blog, or business website',
  },
  {
    id: 'web-app',
    name: 'Web Application',
    icon: Database,
    description: 'Interactive web-based application',
  },
  {
    id: 'mobile-app',
    name: 'Mobile App',
  ...
  },
  {
    ...
    icon: Users,
    description: 'Community or social networking site',
  },
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-300">Choose the option that best describes your vision</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        {projectTypes.map((type) => (
          ...
          >
            ...
            >
              <type.icon
                className={`w-6 h-6 ${selectedType === type.id ? 'text-white' : 'text-gray-600'}`}
              />
            </div>
            <h3
            ...
            <p
              className={`text-sm ${selectedType === type.id ? 'text-gray-200' : 'text-gray-400'}`}
            >
              {type.description}
            </p>
          </button>
